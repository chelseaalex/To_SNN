...
from efficientnet import efficientnetv2_s
...
parser.add_argument('--model_name', default='efficientnetv2_s', type=str, help='model name. vgg16 or resnet20')
...
if __name__ == '__main__':
    ...
    device = torch.device('cuda')#torch.device("cuda" % args.device) if args.cuda else 'cpu'
    ...
    if args.model_name == 'DenseNet':
        net = DenseNet()
        net.load_state_dict(torch.load("./CIFAR10_dense.pth", map_location=device))
